      ...
      <div className="flex items-center space-x-4">
        ...
        {isLoggedIn ? (
          <button
            ...
            className="bg-red-600 text-white rounded-full px-4 py-2 hover:bg-red-700 transition-colors duration-200"
          >
            Logout
          </button>
        ) : (
          <button
            ...
            className="bg-blue-600 text-white rounded-full px-4 py-2 hover:bg-blue-700 transition-colors duration-200"
          >
            Login
          </button>
        )}
